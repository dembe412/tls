    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => (function () {
            ...
            $database = isset($parsedUrl['path']) ? ltrim($parsedUrl['path'], '/') : env('DB_DATABASE', 'postgres');
            $username = isset($parsedUrl['user']) ? rawurldecode($parsedUrl['user']) : env('DB_USERNAME', 'postgres');
            $password = isset($parsedUrl['pass']) ? rawurldecode($parsedUrl['pass']) : env('DB_PASSWORD', '');
