...
class HeroSetting extends Model
{
    ...
    public static function allSettings(): array
    {
        ...
        $description = static::valueFor('description', 'TSL is an IoT equipment investment platform designed for daily returns. Own Tuya-verified smart locks, collect automated daily earnings, and cash out any day once you reach the minimum.');
        ...
        $trust1 = static::valueFor('trust_1', 'Cash Out Any Day');
        $trust2 = static::valueFor('trust_2', 'Daily Automated Earnings');
        $trust3 = static::valueFor('trust_3', 'Min 2,000 UGX · 6% fee');
